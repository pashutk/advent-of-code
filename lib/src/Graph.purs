...
-- https://github.com/purescript/purescript-graphs/blob/master/src/Data/Graph.purs
...
showTree :: forall k v. Show k => Show v => Graph k v -> String
showTree (Graph g) = M.showTree g
